...
HD_PWD='C:/Users/Andreea/Desktop/SSC/InmultireVM/InmultireVM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log InmultireVM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source InmultireVM.tcl
